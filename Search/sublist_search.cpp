...
class TestCases {
 ...
 public:
    ...
    void testCase_1() {
        ...
        vector<uint64_t> sublistData = {
            6};  ///< Data to make linked list which will be the sublist
        vector<uint64_t> mainlistData = {
            2, 5, 6, 7,
    ...
    void testCase_3() {
        ...
        vector<uint64_t> sublistData(20);  ///< Sublist to be searched
        vector<uint64_t> mainlistData(
...
int main(int argc, char *argv[]) {
    ...
    vector<uint64_t> sublistData = {6, 8};  ///< Sublist to be searched
    ...
    if (exists) {
        cout << "[TRUE] - sublist found in main list\n";
    } else {
        cout << "[FALSE] - sublist NOT found in main list\n";
    }
    return 0;
}
