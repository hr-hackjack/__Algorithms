...
/** main function */
int main() {
    cout << "expected value : " << binomial_expected(100, 0.5)
              << endl;

    cout << "variance : " << binomial_variance(100, 0.5) << endl;

    cout << "standard deviation : "
              << binomial_standard_deviation(100, 0.5) << endl;

    cout << "exactly 30 successes : " << binomial_x_successes(100, 0.5, 30)
              << endl;

    cout << "45 or more successes : "
              << binomial_range_successes(100, 0.5, 45, 100) << endl;
