/** An implementation of a median calculation of a sliding window along a
 * data stream
 *
 ...
 * manages a multi-value binary search tree (BST), implemented by multiset.
...
#include <cstdlib>  /// for rand - needed in testing
#include <ctime>    /// for time - needed in testing
#include <list>     /// for list - used to manage sliding window
#include <set>  /// for multiset - used to manage multi-value sorted sliding window values
#include <vector>  /// for vector - needed in testing
using namespace std;
...
class WindowedMedian {
    ...
    multiset<int> _sortedValues;  ///< a DS to represent a balanced
                                       /// multi-value binary search tree (BST)
    multiset<int>::const_iterator
