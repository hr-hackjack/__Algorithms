...
int main() {
    ...
    cout << "Poisson rate : " << rate << endl;

    expected = poisson_expected(rate, 2);
    cout << "Poisson expected : " << expected << endl;

    cout << "Poisson 0 successes : " << poisson_x_successes(expected, 0)
              << endl;
    cout << "Poisson 0-8 successes : "
              << poisson_range_successes(expected, 0, 8) << endl;
